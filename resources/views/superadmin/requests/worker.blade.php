...
@section('title', 'Worker Requests')

@section('content')
<div class="container">
    <h3 class="text-center mb-4 fw-bold">Pending Worker Requests</h3>
...
<div class="table-container boxshadow">
    <table class="responsive-table">
        <caption class="fs-6">Pending Worker Requests</caption>
        <thead>
            <tr>
                <th scope="col">ID</th>
            ...
            <tr>
                ...
                {{-- <td data-title="Actions">
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <form action="{{ route('superadmin.worker.reject', $worker->id) }}" method="POST">
                            @csrf
